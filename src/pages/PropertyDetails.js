    ...
    <section>
      <div className="container mx-auto min-h-[800px] mb-14">
        ...
        <div className="flex flex-col items-start gap-8 lg:flex-row">
          {/* image + bed+ description */}
          <div className="max-w-[768px]">
            <div className="mb-8">
              <img src={house.imageLg} alt="imageLg" />
            </div>
          ...
          <div className='flex-1 bg-white w-full mb-8 border border-gray-300 rounded-lg px-6 py-8'>
            ...
            <form className='flex flex-col gap-y-4'>
              ...
              <div className='flex gap-x-2'>
                <button className='p-4 bg-violet-700 hover:bg-violet-800 transition text-white rounded text-sm w-full'>Send message</button>
                <button className='w-full border border-violet-700 focus:border-violet-500 text-violet-700 focus:text-violet-500 text-sm rounded transition p-4'>Call</button>
              </div>
            </form>
          </div>
        </div>
